...
# Get the true home directory of the user (handles sudo execution)
if [ -n "${SUDO_USER:-}" ]; then
...
SCRIPTSDIR="$USER_HOME/.config/hypr/scripts"
...
iDIR="$USER_HOME/.config/swaync/images"
iDIRi="$USER_HOME/.config/swaync/icons"
